    ...
    <div className="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-32">
      ...
      {itemSeleccionado && (
        <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-[#0A130D] border border-[#CBA36A]/30 p-8 rounded-t-[2.5rem] md:rounded-[2.5rem] w-full max-w-md relative animate-in slide-in-from-bottom-10 md:slide-in-from-bottom-0">
  ...
  return (
    <main className="relative w-full min-h-screen bg-[#060B08] text-[#CBA36A] font-sans antialiased overflow-x-hidden selection:bg-[#CBA36A] selection:text-[#060B08]">
      ...
      <header className="fixed top-0 left-0 w-full z-50 p-6 flex justify-between items-center bg-[#060B08]/80 backdrop-blur-md border-b border-[#CBA36A]/10 shadow-lg">
        <a href="/" className="flex items-center gap-2 text-[#CBA36A] hover:text-white transition-colors">
        ...
        <a href="/carrito" className="flex items-center gap-2 bg-[#CBA36A] px-4 py-2 md:px-5 md:py-2.5 rounded-full text-[#060B08] text-[10px] font-black uppercase tracking-widest active:scale-90 transition-all shadow-[0_0_15px_rgba(203,163,106,0.4)]">
